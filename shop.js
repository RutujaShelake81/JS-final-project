...
for (var i = 0; i < productList.length; i++) {
  ...
  for (var x in productList[i]) {
    // console.log(x)
    console.log(productList[i][x]);
    if (x == "photos") {
      // console.log(x)
      var img_tag = document.createElement('img');
      img_tag.className = "img_style"
      img_tag.src = productList[i][x][0]
      a.appendChild(img_tag);
      if(i==0){
      ...
      var h4_tag = document.createElement('h3');
      h4_tag.className = "name_tag"
      h4_tag.innerHTML += productList[i][x]
      ...
      p_tag.className = "price"
      p_tag.innerHTML += "RS" + " " + productList[i][x]
      ...
      p_tag.className = "brand"
      p_tag.innerHTML += productList[i][x]
      div_tag.appendChild(p_tag);
      // console.log(p_tag)
  ...
  if (i == 5 || i == 6 || i == 7 || i == 8 || i == 9) {
    document.getElementById('main_section_2').appendChild(div_tag);
  }
}  
...
n = document.getElementById("cart_count");
